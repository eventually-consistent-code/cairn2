...
export function pluginCacheVersion(modulePath) {
...
export function repoVersions(projectDir) {
...
export async function fetchNpmLatest(fetchImpl = fetch, timeoutMs = 2500) {
    try {
