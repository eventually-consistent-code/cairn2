 ...
 */
export function loadTemplate(name, slots, rootDir = DEFAULT_ROOT_DIR) {
    ...
    if (file.includes("/") || file.includes("\\") || file.includes("..")) {
        throw new CairnError("NOT_FOUND", `peer template '${name}' not found`, "template names are bare file names under skills/cairn-trailhead/templates/peers/");
    }
    ...
    try {
        ...
        throw new CairnError("NOT_FOUND", `peer template '${name}' not found`, `expected it at ${join(TEMPLATE_SUBDIR, file)}`);
    }
