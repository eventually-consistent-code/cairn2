...
export function buildServer(deps: {
  ...
  server.registerTool("config_probe",
    ...
    wrap(async () => {
      const d = dir();
      const out: { tracker: ProbeResult; docs?: ProbeResult; versions?: InstalledVersions } = {
  ...
  server.registerTool("outlook_get",
    { description: "Portfolio aggregate (#55): every registered cairn project on this machine as a "
      ...
      inputSchema: { artifact: z.boolean().optional() } },
  ...
  server.registerTool("peer_state",
    ...
    wrap((a: { slug: string;
      ...
      findingId?: string; verdict?: Verdict; note?: string; allowIncomplete?: boolean }) => {
      const d = dir();
