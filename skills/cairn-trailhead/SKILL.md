...
| `audit` | Cross-phase quality audits — uat/milestone/security[--surface]/ui/eval/validation/tests/plans/docs/simplify/memory | `<mode> [target]` \| `--fix` | verbs/audit.md | live |
...
| `outlook` | Portfolio board — every cairn project on this machine, staleness-flagged, cost rollup | `[<project>]` \| `--refresh` \| `forget <project>` | verbs/outlook.md | live |
