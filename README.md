...
**Server:** <!-- auto:tool-count -->86<!-- /auto:tool-count --> typed MCP tools, <!-- auto:test-count -->1528<!-- /auto:test-count --> passing tests — counts move with each
...
Every install gets the full <!-- auto:tool-count -->86<!-- /auto:tool-count -->-tool surface, the generated `AGENTS.md` verb
...
| Harness | Tools (<!-- auto:tool-count -->86<!-- /auto:tool-count -->) | Verbs | Slash commands | Continuity/cost/observe hooks |
|---|---|---|---|---|
